...
\section{Anforderungsanalyse}\label{sec:Anforderungsanalyse}
	...
	\item
		Es \textbf{SOLL} erarbeitet werden, welche Aspekte von Spam analysiert werden können.
...
\section{Umsetzung}\label{sec:Umsetzung}
	...
	\subsection{Host Einrichtung}\label{sec:UmsetzungHostEinrichtung}
		...
		\subsubsection{DNS Einträge}\label{sec:DNSEinträge}
			...
			Zusätzlich zu den DNS-Einträgen für die Mailserver wird noch ein Eintrag für die Website erstellt.
...
\begin{lstlisting}[label={lst:PHP-Script},caption={PHP-SMTP-Persistance-Script (selbst erstellt)}]
#!/usr/bin/php
<?php
...
// @see https://github.com/ddeboer/imap
