...
Spam zu bekommen wenn man wirklich welchen bekommen möchte, ist einfacher als es sich zuerst darstellt. Um auf Spam-Listen zu landen müssen entweder bei Diensten Nutzerdaten in die Hände dritter gelangt sein oder es wird zufällig die eigene Mail gespammt, durch einen Spammer der einfach E-Mail-Adressen ausprobiert. Da wir aktiv viel Spam erhalten wollten gestaltete sich die Verbreitung der Mails als eher langwieriger Prozess, dennoch konnten wir am Ende des Projektes einige Spam-Mails identifizieren. Das verbreiten des Open-Relay-Servers unter Spammern ist an dieser Stelle gescheitert, da Spammer ihre Methoden weder dokumentieren, noch offen über Ihr Vorgehen sprechen und wir somit keine Möglichkeit gefunden haben tatsächliche Spammer anzulocken. Auch die für Crawler angelegten E-Mails von der Webseite wurden nicht gespammt. Falls man einen Weg findet um als wirklicher Honigtopf für Spammer zu wirken könnte man die Mails besser  analysieren und könnte herausfinden was sich zu analysieren lohnt, da uns dies jedoch nicht gelang haben wir nur theoretische Überlegungen anstellen können was sich analysieren ließe. Nichtsdestotrotz wäre dieses Projektkonzept geeignet Spam zu erhalten und zu analysieren insofern sich die Catch-All-Mail-Adresse und der Open-Relay-Server unter Spammern publizieren lässt.
